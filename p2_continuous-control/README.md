...
| ![Rewards during training](report_submission/success-raw.png "Rewards during training")  | 
|:--:| 
...
My project submission solves the second version of the environment. 
...
- After each episode, we add up the rewards that each agent received (without discounting), to get a score for each agent. This yields 20 (potentially different) scores. Then take the **average of these 20 scores**. 
